...
extension ClassroomQueryWhereSort
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhere> anyId() {
...
extension ClassroomQueryWhere
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Classroom, Classroom, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension ClassroomQueryFilter
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeEqualTo(
    String value, {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'grade',
        value: '',
  ...
  QueryBuilder<Classroom, Classroom, QAfterFilterCondition> gradeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'grade',
        value: '',
...
extension ClassroomQuerySortBy on QueryBuilder<Classroom, Classroom, QSortBy> {
  QueryBuilder<Classroom, Classroom, QAfterSortBy> sortByGrade() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'grade', Sort.asc);
    });
  }

  QueryBuilder<Classroom, Classroom, QAfterSortBy> sortByGradeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClassroomQuerySortThenBy
  ...
  QueryBuilder<Classroom, Classroom, QAfterSortBy> thenByGrade() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'grade', Sort.asc);
    });
  }

  QueryBuilder<Classroom, Classroom, QAfterSortBy> thenByGradeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'grade', Sort.desc);
    });
  }
...
extension ClassroomQueryWhereDistinct
  ...
  QueryBuilder<Classroom, Classroom, QDistinct> distinctByGrade(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ClassroomQueryProperty
  ...
  QueryBuilder<Classroom, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<Classroom, String, QQueryOperations> gradeProperty() {
    return QueryBuilder.apply(this, (query) {
